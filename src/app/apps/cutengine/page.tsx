...
const highlights = [
  {
    label: 'ML-Adaptive',
    description:
      'Daily calorie targets that learn YOUR metabolic response, not population averages.',
  },
  {
    label: 'HealthKit-First',
    description:
      'Apple Watch data — activity, sleep, HRV — flows in automatically. No manual logging.',
  },
  {
    label: 'Recovery-Aware',
    description:
      '6-signal biofeedback system auto-reduces deficit when recovery declines.',
  },
  {
    label: 'Enhancement-Tier Aware',
    description:
      'Natural, TRT, GLP-1, peptides — the algorithm adapts to your context.',
  },
]
        ...
        <FadeIn>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-zinc-400">
              ...
              for HR zone training. Together they share user data via App Groups
