  ...
  return (
    <article key={page.href}>
      ...
      >
        ...
        <Link
          href={page.href}
          className="mt-6 flex gap-x-3 text-base font-semibold text-zinc-300 transition hover:text-white"
...
export function PageLinks({
  ...
  return (
    <div className={clsx('relative pt-24 sm:pt-32 lg:pt-40', className)}>
      <div className="absolute inset-x-0 top-0 -z-10 h-[884px] overflow-hidden rounded-t-4xl bg-linear-to-b from-zinc-900">
        <GridPattern
          className="absolute inset-0 h-full w-full mask-[linear-gradient(to_bottom_left,white_40%,transparent_50%)] fill-zinc-800 stroke-zinc-700/20"
          yOffset={-270}
        />
      </div>
