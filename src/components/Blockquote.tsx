...
function BlockquoteWithImage({
  ...
  return (
    ...
    >
      <blockquote className="col-span-2 text-xl/7 text-zinc-400 sm:col-span-7 sm:col-start-6 sm:row-start-2">
        {typeof children === 'string' ? <p>{children}</p> : children}
      </blockquote>
      <div className="col-start-1 row-start-2 overflow-hidden rounded-xl bg-zinc-800 sm:col-span-5 sm:row-span-full sm:rounded-3xl">
        <Image
          alt=""
          {...image}
